...
class TransactionList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(                                          // envolvemos a lista em um container para
      height: 385,                                             // um tamenho definido por conta da
      child: SingleChildScrollView(                            // barra de rolagem apenas da lista
            child: Column(                                     // Criamos um acoluna que tem um filho 
